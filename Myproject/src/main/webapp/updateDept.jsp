...
<fieldset><legend>Update Department</legend>
<label for="field1"><span>Employee No: <span class="required">*</span></span><input type="text" class="input-field" name="empNo" value="" /></label>
<label for="field1"><span>Enter Department: <span class="required">*</span></span><input type="text" class="input-field" name="empDept" value="" /></label>
